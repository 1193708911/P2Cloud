...
import static com.ctvit.p2cloud.R.*;
...
public class AnchorOverlay extends VideoTrackOverlay {
    ...
    public AnchorOverlay(Context context) {
        ...
        mAnchor = new Anchor();
        mDefaultAnchorPosition = context.getResources().getDimensionPixelOffset(dimen.default_anchor_position);
        mAnchorWidth = context.getResources().getDimensionPixelOffset(dimen.anchor_width);
        mAnchorRound = context.getResources().getDimensionPixelOffset(dimen.anchor_round);
        mAnchorArea = context.getResources().getDimensionPixelOffset(dimen.anchor_area);
        isVideoOpen = false;
