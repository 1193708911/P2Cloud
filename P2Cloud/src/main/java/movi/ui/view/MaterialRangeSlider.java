...
public class MaterialRangeSlider extends View {
    ...
    private static final int DEFAULT_TOUCH_TARGET_SIZE = Math.round(DenityUtils.dpToPx(40));
    ...
    private void getDefaultColors() {
        ...
        colorControlNormal = materialStyledAttrs.getColor(0, appcompatMaterialStyledAttrs.getColor(0, Color.RED));
        colorControlHighlight = materialStyledAttrs.getColor(1, appcompatMaterialStyledAttrs.getColor(1, Color.BLACK));
    ...
    private void getDefaultMeasurements() {
        pressedRadius = Math.round(DenityUtils.dpToPx(DEFAULT_PRESSED_RADIUS));
        unpressedRadius = Math.round(DenityUtils.dpToPx(DEFAULT_UNPRESSED_RADIUS));
        insideRangeLineStrokeWidth = Math.round(DenityUtils.dpToPx(DEFAULT_INSIDE_RANGE_STROKE_WIDTH));
        outsideRangeLineStrokeWidth = Math.round(DenityUtils.dpToPx(DEFAULT_OUTSIDE_RANGE_STROKE_WIDTH));
    }
