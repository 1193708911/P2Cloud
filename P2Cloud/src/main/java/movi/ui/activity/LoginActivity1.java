...
public class LoginActivity1 extends FragmentActivity implements NetCallBack, AdapterView.OnItemClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    //文件下载线程
    private MyAlertDialog pgLoadDialog;
    private String path = "";
            ...
            if (loginListBean != null) {
                if (loginListBean.getData() != null) {
                    if (loginListBean.getStatus() != 200) {
                        ToastUtils.showToast(LoginActivity1.this, loginListBean.getMsg());
                        return;
                    }
