...
import movi.view.MySquereImageView;
 ...
 * @Date: 2015/11/4
 */
public class MobileBottomPicAdapter extends MyBaseAdapter<NewsSheetPicBean> {
    ...
    public MobileBottomPicAdapter(Context context, ArrayList<NewsSheetPicBean> mDatas) {
...
//        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (position == TYPE_CAMERA) {
            ...
            if (convertView == null) {
                ...
                holder.imageview_photo = (MySquereImageView) convertView.findViewById(R.id.imageview_photo);
    ...
    private class ViewHolder {
        ...
        private MySquereImageView imageview_photo;
