 ...
 * 视频资源
 */
public class NewsSheetMovieListBean extends Response implements Serializable{
    private String playliststatus;
    private String       title;
    private ArrayList<NewsMovieBean>  data;
    ...
    public ArrayList<NewsMovieBean> getData() {
        return data;
    }

    public void setData(ArrayList<NewsMovieBean> data) {
        this.data = data;
    }

    public class NewsMovieBean{
    private String    id;
